...
*   Match ovxlib 1.1.30
*
*   Neural Network appliction network definition source file for NBG format
****************************************************************************/
/*-------------------------------------------
                   Includes
 -------------------------------------------*/
...
#include "vnn_sface_network_binary.h"
...
vsi_nn_graph_t * vnn_CreateSfaceNBG
    (
...
error:
    ...
    vnn_ReleaseSfaceNBG( graph, release_ctx );

    return NULL;
} /* vnn_CreateSfaceNBG() */

void vnn_ReleaseSfaceNBG
    (
    vsi_nn_graph_t * graph,
    vsi_bool release_ctx
    )
