...
*   YuNet Face Detection Model - Network Binary (.nb format)
****************************************************************************/
/*-------------------------------------------
                   Includes
 -------------------------------------------*/
...
/*-----------------------------------------
 ...
 -----------------------------------------*/
    ...
    attr.dim_num = 3;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_NONE;
    NEW_NORM_TENSOR(norm_tensor[5], attr, VSI_NN_TYPE_FLOAT16);
    ...
    attr.dim_num = 3;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_NONE;
    NEW_NORM_TENSOR(norm_tensor[6], attr, VSI_NN_TYPE_FLOAT16);
    ...
    attr.dim_num = 3;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_NONE;
    NEW_NORM_TENSOR(norm_tensor[7], attr, VSI_NN_TYPE_FLOAT16);
    ...
    attr.dim_num = 3;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_NONE;
    NEW_NORM_TENSOR(norm_tensor[8], attr, VSI_NN_TYPE_FLOAT16);
    ...
    attr.dim_num = 3;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_NONE;
    NEW_NORM_TENSOR(norm_tensor[9], attr, VSI_NN_TYPE_FLOAT16);
    ...
    attr.dim_num = 3;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_NONE;
    NEW_NORM_TENSOR(norm_tensor[10], attr, VSI_NN_TYPE_FLOAT16);
    ...
    attr.dim_num = 3;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_NONE;
    NEW_NORM_TENSOR(norm_tensor[11], attr, VSI_NN_TYPE_FLOAT16);
    ...
    attr.dim_num = 4;
    attr.dtype.qnt_type = VSI_NN_QNT_TYPE_NONE;
    NEW_NORM_TENSOR(norm_tensor[12], attr, VSI_NN_TYPE_FLOAT16);
